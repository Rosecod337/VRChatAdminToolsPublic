...
Version `0.3.3-beta.6`: current world detection now prefers confirmed `world-joined` events instead of temporary loading markers like `Entering Room` or `Joining`.
...
Актуальная версия на момент этого описания: `0.3.3-beta.6`.
