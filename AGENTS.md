...
- `apps/client-beta/`: Beta upgrade bridge and the shell-neutral renderer shared with the new stable client.
- `apps/client-stable/`: Stable 2.0 package identity and release settings; build shares the Beta renderer and trusted client core.
