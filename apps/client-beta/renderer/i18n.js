(function initBetaI18n(root, factory) {
  ...
  const EN = Object.freeze({
    ...
    "Войдите через Настройки. Пароль не сохраняется, а сессия хранится зашифрованной локально.": "Sign in through Settings. Your password is never stored, and the session is encrypted locally.",
    ...
    "Аккаунт VRChat не подключён. Войдите в него через Настройки и повторите действие.": "The VRChat account is not connected. Sign in through Settings and try again.",
    "Сессия VRChat истекла. Войдите в аккаунт заново через Настройки.": "The VRChat session has expired. Sign in again through Settings.",
    ...
    "Войти в VRChat можно через настройки приложения.": "You can sign in to VRChat through app settings.",
