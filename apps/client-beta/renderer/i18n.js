(function initBetaI18n(root, factory) {
  ...
  const EN = Object.freeze({
    ...
    "По платному ключу": "Paid key required",
    "Проверь, насколько хорошо помнишь собственные миры VRChat. Данные остаются на этом устройстве.": "See how well you remember your own VRChat worlds. The data stays on this device.",
    "Выбор игры": "Choose a game",
    "Какой мир был позже?": "Which world was later?",
    "Сколько сессий?": "How many sessions?",
    "Выбери игру": "Choose a game",
    "Для игры нужны сохранённые посещения миров.": "Saved world visits are needed to play.",
    "Следующий вопрос": "Next question",
    "Сыграть ещё": "Play again",
    "очков": "points",
    "0 очков": "0 points",
    "Загружаем историю миров…": "Loading world history…",
    "Пока не хватает истории миров": "Not enough world history yet",
    "Для этой игры нужны хотя бы два мира с разным временем посещения.": "This game needs at least two worlds with different visit times.",
    "Для этой игры нужен мир с сохранёнными сессиями.": "This game needs a world with saved sessions.",
    "Сколько сохранённых сессий связано с миром": "How many saved sessions are linked to world",
    "Какой из этих миров ты посещал позже остальных?": "Which of these worlds did you visit most recently?",
    "Выбери один вариант.": "Choose one answer.",
    "Не удалось загрузить историю миров": "Could not load world history",
    "Попробуйте открыть игры ещё раз.": "Try opening the games again.",
    "Верно!": "Correct!",
    "Не угадал.": "Not quite.",
    ...
    "Оформление всего интерфейса": "Customize the whole interface",
    ...
    "Нужен профиль до 256 КБ; максимум 8 профилей.": "Use a profile up to 256 KB; maximum 8 profiles.",
    "Стабильная версия 2.0": "Stable version 2.0",
    "Локальные функции доступны бесплатно. Версия 2.0 сохраняет настройки и историю установленной Beta и не меняет прежнее приложение 1.1.8.": "Local features are free. Version 2.0 keeps settings and history from the installed Beta and leaves the previous 1.1.8 app unchanged.",
    "Ключ доступа": "Access key",
    "ваш существующий ключ": "your existing key",
    ...
    "Перенести вход из версии 1.1.8": "Import sign-in from version 1.1.8",
    ...
    "Realtime работает": "Realtime connected",
    "Подключение…": "Connecting…",
    "Переподключение…": "Reconnecting…",
    "Нужно переподключить аккаунт": "Reconnect your account",
    "Ошибка realtime": "Realtime error",
    "Аккаунт не подключён": "Account not connected",
    "Realtime отключён": "Realtime disconnected",
    ...
    "Настройки 2.0": "Version 2.0 settings",
    ...
    "Отчёт о сессии сохранён.": "Session report saved.",
    "Экспорт .txt": "Export .txt",
    "Скрыть имена в отчёте": "Hide names in report",
    "Участник": "Participant",
    "Очистка локальных данных": "Local data cleanup",
    "Очистить историю": "Clear history",
    "Очистить друзей": "Clear friend data",
    "Очистить заметки": "Clear notes",
    "Очистить всё": "Clear everything",
    "Очищаем…": "Clearing…",
    "Выбранные локальные данные удалены.": "Selected local data was deleted.",
    "Не удалось очистить данные.": "Could not clear the data.",
    "Не удалось экспортировать сессию.": "Could not export the session.",
    "историю сессий": "session history",
    "ленту и список друзей": "friend feed and list",
    "локальные заметки и избранное": "local notes and favorites",
    "все локальные данные": "all local data",
    "выбранные данные": "the selected data",
    "Без оценки": "Not rated",
    "Неизвестная платформа": "Unknown platform",
    "Unity не указан": "Unity version unavailable",
    "Апелляция открыта": "Appeal open",
    "Апелляция сохранена.": "Appeal saved.",
    "Без апелляции": "No appeal",
    "За дней": "Window, days",
    "Инцидентов": "Incidents",
    "Исключён — действие не применяется": "Excluded — no action is applied",
    "Исключения: usr_… через пробел": "Excluded usr_… IDs separated by spaces",
    "Комментарий к апелляции": "Appeal comment",
    "На рассмотрении": "Under review",
    "Не удалось открыть доказательство.": "Could not open the evidence.",
    "Не удалось сохранить апелляцию.": "Could not save the appeal.",
    "Общая лента инцидентов": "Shared incident timeline",
    "Отклонена": "Rejected",
    "Открыть доказательство": "Open evidence",
    "По выбранному правилу совпадений нет.": "No matches for the selected rule.",
    "Принята": "Accepted",
    "Проверка правила до включения": "Test rule before enabling",
    "Симуляция ничего не применяет. Она использует только завершённые бан-действия из общей истории команды.": "The simulation does not apply changes. It only uses completed ban actions from the team's shared history.",
    "Сохранить апелляцию": "Save appeal",
    "Аватары игрока": "Player avatars",
    "Выбрать этот аватар для вашего VRChat-аккаунта? VRChat применит его как текущий аватар.": "Select this avatar for your VRChat account? VRChat will apply it as your current avatar.",
    "Надеваем…": "Selecting…",
    "Надеть": "Select",
    "Скрыть аватары": "Hide avatars",
    "Смена аватара": "Avatar change",
    "VRChat передал только изображение — Avatar ID неизвестен": "VRChat provided only an image — the Avatar ID is unknown",
    "VRChat пока не передал сведения об аватарах этого игрока.": "VRChat has not provided avatar information for this player yet.",
